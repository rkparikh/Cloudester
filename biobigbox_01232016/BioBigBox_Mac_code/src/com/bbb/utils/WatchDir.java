...
public class WatchDir {
    ...
    void processEvents() {
        for (;;) {
            ...
            for (WatchEvent<?> event : key.pollEvents()) {
                ...
                //System.out.println("Folder Watcher First " + child.toString() + " Event" + event.kind().name());
              ...
              }  else if(child.toString().contains(".DS_Store") && Initialize.uploadingfile.equals(child.toString())){
                    Initialize.tempMap.put(child.toString(), "ENTRY_DELETE");
                }     
                    else if (!Initialize.uploadingfile.equals(child.toString()) && !child.toString().contains(".DS_Store")) {
                    Initialize.tempMap.put(child.toString(), "ENTRY_MODIFY" );                    
                    System.out.println("Watch Directory " + child.toString() + " Map Size " + Initialize.tempMap.size());
                }
    ...
    public static void watchSource(String directory) throws IOException {
        ...
        System.out.println("Watch Directory Call..............................................................");
