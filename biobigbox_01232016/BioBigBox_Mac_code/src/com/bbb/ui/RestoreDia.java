...
//                            BorderFactory.createLineBorder(new Color(30,144,255), 2))));
    ...
    private void initComponents() {
        ...
        listTable.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    public static Thread stopDownloadThread;
    private void login1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login1ActionPerformed
        ...
        if (subList == null || subList.size() == 0) {
            JOptionPane.showMessageDialog(this, "Please Select Files or Folders ", "Error",
                    JOptionPane.ERROR_MESSAGE,TrayIconUtils.errImageIcon);
        } else {
            ...
            if (!downloadDirectory.equals("")) {
               ...
               stopDownloadThread= new Thread(new RestoreProcessThread());
               stopDownloadThread.start();
            } else {
                JOptionPane.showMessageDialog(this, "Please Select Default Directory ", "Error",
                        JOptionPane.ERROR_MESSAGE,TrayIconUtils.errImageIcon);
            }
        }
