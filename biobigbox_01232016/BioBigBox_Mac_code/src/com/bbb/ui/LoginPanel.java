...
//                }
    ...
    private void forgotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_forgotActionPerformed
        // TODO add your handling code here:
        try {
            Desktop.getDesktop().browse(new URL("http://biobigbox.com/#/forgot-password").toURI());
            logger.info("Account");
        } catch (Exception ex) {
...
//                                    }
                                ...
                                try {
                                    Desktop.getDesktop().browse(new URL("https://biobigbox.com/#/mac-login-success").toURI());
